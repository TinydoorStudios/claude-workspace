...
*Restart Computer* in the same menu reboots the control PC without touching the audio engine. *Quit to Windows/Home* drops you to Quantum Home, which is where display and network settings live.

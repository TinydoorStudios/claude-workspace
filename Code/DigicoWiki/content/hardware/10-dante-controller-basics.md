...
**Routing**: a grid of transmitters across the top, receivers down the side. Click a crosspoint to subscribe; a green tick means flowing. Subscribe the DMI card's receive channels 1–48 to the DQ-Rack's transmit channels 1–48 (and 49–56 for the rack's AES outs), and the rack's receive channels 1–24 to the DMI card's transmit 1–24. Do the A168D the same way on the next block of DMI channels. Keep the numbering 1:1 so the console's socket names stay honest.

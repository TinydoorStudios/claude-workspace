...
lines = [
    ...
    ("Rows sharing Event Name + Date + Venue are ONE event (a bill). Give each act its Start —", False),
    ("earliest start is Artist 1 on the paperwork, latest is Artist 3. Nothing else sets the order.", False),
    ...
    ("  ACT — set length, the exact artist name, and the email the advance goes to.", False),
    ...
    ("  Row 1: 513 Airwaves w/ Inhaler | 2026-09-20 | Fountain Square | 9:00p | 60 min | Buffalo Wabs...", False),
    ("  Row 2: 513 Airwaves w/ Inhaler | 2026-09-20 | Fountain Square | 7:00p | 45 min | The Cincy Suns", False),

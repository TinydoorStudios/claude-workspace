...

{
  ...
  tar -C "$HERE/tools" -czf /tmp/adv_tools.tgz draft_emails.py backfill.py event.py daysheet.py sheet.py import_sheet.py fieldspec.py build_template.py dump_followups.py status_sheet.py package_run.py venue_email.py seed_bookings.py append_bookings.py merge_status.py run_now.py status_log.py email_templates lists doc_templates || exit 1

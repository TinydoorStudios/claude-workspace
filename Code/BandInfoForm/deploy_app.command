...

{
  ...
  tar -C "$HERE/tools" -czf /tmp/adv_tools.tgz draft_emails.py docfill.py backfill.py event.py daysheet.py sheet.py import_sheet.py email_templates lists doc_templates || exit 1

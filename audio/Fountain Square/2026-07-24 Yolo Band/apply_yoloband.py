...
(3,779,766 bytes — resaved 2026-06-21; recalibrated by ZZTOP save-diff,
console-verified). Old constants for reference: SURF_BASE 0xA287A,
SCAN 0x1A1000..0x1CC000 (2,466,215-byte template, retired).
...
CAL = dict(
    ...
    n_faders=64,
    block_mode='scan',
    scan_lo=0x2D3000,      # current-scene channel-block region
    scan_hi=0x33F000,
    ...
    expected_names=[
        ...
        'Bricasti 3', 'Bricasti 4', 'Ch 45', 'Ch 46', 'Ch 47', 'Ch 48',
